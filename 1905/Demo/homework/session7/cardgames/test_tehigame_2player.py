"""Pytest tests for tehigame_2player module"""
import pytest
from tehigame_2player import TehiHand, TehiGame
from cardlib_enum import CardRank, CardSuit, PlayingCard, FaceCard


class TestTehiHand:
    """Test cases for TehiHand class"""
    ...
    def test_hand_deal(self):
        """Test dealing a hand"""
        from cardlib_enum import CardDeck
        deck = CardDeck()
        hand = TehiHand()
        hand.deal(deck)
    ...
    def test_hand_score_all_regular_cards(self):
        ...
        for rank in [CardRank.ACE, CardRank.TWO, CardRank.THREE, CardRank.FOUR, CardRank.FIVE]:
            card = PlayingCard(rank, CardSuit.CLUBS)
            card.faceup = True
            hand._hand.append(card)
        assert hand.score == 0
    ...
    def test_hand_score_mixed(self):
        ...
        # Score = 4 * 6 = 24
        hand._hand.append(FaceCard(CardRank.JACK, CardSuit.CLUBS))
        hand._hand.append(FaceCard(CardRank.QUEEN, CardSuit.CLUBS))
        hand._hand.append(PlayingCard(CardRank.ACE, CardSuit.CLUBS))
        hand._hand.append(PlayingCard(CardRank.TWO, CardSuit.CLUBS))
        hand._hand.append(PlayingCard(CardRank.THREE, CardSuit.CLUBS))
        for card in hand._hand:
            card.faceup = True
    ...
    def test_hand_score_one_eyed_cards(self):
        ...
        # Add 3 regular cards (1+2+3 = 6 total rank)
        # Score = 2 * 6 = 12
        hand._hand.append(FaceCard(CardRank.JACK, CardSuit.HEARTS))
        hand._hand.append(FaceCard(CardRank.KING, CardSuit.DIAMONDS))
        hand._hand.append(PlayingCard(CardRank.ACE, CardSuit.CLUBS))
        hand._hand.append(PlayingCard(CardRank.TWO, CardSuit.CLUBS))
        hand._hand.append(PlayingCard(CardRank.THREE, CardSuit.CLUBS))
        for card in hand._hand:
    ...
    def test_hand_comparison_gt(self):
        ...
        hand1 = TehiHand()
        hand2 = TehiHand()
        hand1._hand.append(FaceCard(CardRank.JACK, CardSuit.CLUBS))
        hand1._hand.append(PlayingCard(CardRank.ACE, CardSuit.CLUBS))
        hand2._hand.append(PlayingCard(CardRank.ACE, CardSuit.CLUBS))
    ...
    def test_hand_comparison_lt(self):
        ...
        hand2 = TehiHand()
        hand1._hand.append(PlayingCard(CardRank.ACE, CardSuit.CLUBS))
        hand2._hand.append(FaceCard(CardRank.JACK, CardSuit.CLUBS))
        hand2._hand.append(PlayingCard(CardRank.ACE, CardSuit.CLUBS))
        for card in hand1._hand + hand2._hand:
            card.faceup = True
        assert hand1 < hand2
