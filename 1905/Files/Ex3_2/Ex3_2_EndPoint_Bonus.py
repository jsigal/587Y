...
if flightlist[0] in city_code_dict and flightlist[1] in city_code_dict:
    print('Both', flightlist[0], 'and', flightlist[1], 'are keys')
else:
    print('We do not fly from', flightlist[0], 'to', flightlist[1])
...
print([key for key in flightdict if flightdict[key][0] == 'HNL'])

print('The roundtrip flights', end='')
print([key for key in flightdict if flightdict[key][0] == flightdict[key][1]])

print('The sorted flights')
keylist = list(flightdict)
keylist.sort()
for key in keylist:
    print(key, flightdict[key])
...
city_codes = ','.join(airports).split(',')
print('List of codes', city_codes[::2])
print('List of cities', city_codes[1::2])
